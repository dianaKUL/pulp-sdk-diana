...
#define ARCHI_FC_HWPE_DIG_OFFSET      0x0000C000
#define ARCHI_FC_HWPE_ANA_OFFSET      0x0000D000
...
#define ARCHI_FC_HWPE_DIG_ADDR       ( ARCHI_SOC_PERIPHERALS_ADDR + ARCHI_FC_HWPE_DIG_OFFSET )
#define ARCHI_FC_HWPE_ANA_ADDR       ( ARCHI_SOC_PERIPHERALS_ADDR + ARCHI_FC_HWPE_ANA_OFFSET )
